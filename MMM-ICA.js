Module.register("MMM-ICA", {
  ...
  getDom: function() {
    // your getDom function here
  },
  
  socketNotificationReceived: function(notification, payload) {
    // your socket notification handler here
  },
  
  getCardAccounts: function() {
    // your getCardAccounts function here
  },
  
  getFavoriteStores: function() {
    // your getFavoriteStores function here
  }
});
socketNotificationReceived: function(notification, payload) {
  console.log("Received socket notification:", notification, "with payload:", payload);

  if (notification === "CARD_ACCOUNTS_RESULT") {
    if (payload.error) {
...
socketNotificationReceived: function(notification, payload) {
  ...
  if (notification === "CARD_ACCOUNTS_RESULT") {
    // Handle card account data
  } else if (notification === "FAVORITE_STORES_RESULT") {
    // Handle favorite stores data
  } else {
    console.warn(`Unknown socket notification received: ${notification}`);
  }
}
